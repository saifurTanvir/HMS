...
@section('content')
  ...
  <div class="btn-group">
    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Department</button>
    <div class="dropdown-menu">
      @foreach ($department as $dep)
     <a class="dropdown-item" href="{{route('SuperAdmin.DoctorDepartment',$dep->Department)}}">{{$dep->Department}}</a>
